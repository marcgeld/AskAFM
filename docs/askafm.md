...
into a DataFrame and exposed through the read-only `tabularData` and
`insightView` tools.

## Architecture

See [FilterModeArchitecture.md](FilterModeArchitecture.md) for the filter-mode architecture, configuration model, and generated documentation workflow.
